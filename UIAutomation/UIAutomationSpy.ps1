...
# default: $true
# ------------------------------------------------------
[UIAutomation.Preferences]::HighlighterColor = [System.Drawing.Color]::Blue;
...
# ------------------------------------------------------
# Hides/shows the Cached, CachedParent and CachedChilren properties of AutomationElement
# default: [UIAutomation.Preferences]::UseElementsCached = $false
[UIAutomation.Preferences]::UseElementsCached = $true;

# ------------------------------------------------------
# Hides/shows the Current property of AutomationElement
# default: [UIAutomation.Preferences]::UseElementsCurrent = $false
[UIAutomation.Preferences]::UseElementsCurrent = $true;
